...
PG·서버 주문 검증·인증, 실제 쿠폰·적립금·배송지 저장은 외부 연동 대기입니다. 현재 주문서에는 별도 약관 동의 단계를 두지 않습니다. 카드별 무이자 정책 API가 없어 신한카드의 Figma 예시만 할부 옵션을 제공하고 다른 카드는 일시불을 제공합니다.
