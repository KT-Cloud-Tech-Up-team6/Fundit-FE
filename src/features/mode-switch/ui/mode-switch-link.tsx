...
export function ModeSwitchLink({ mode }: ModeSwitchLinkProps) {
  ...
  return (
    <Link
      href={target}
      className="border-w-xs border-border-primary bg-layer-surface-default text-body-s text-text-default hover:bg-layer-surface-disabled flex h-9 w-9 items-center justify-center gap-2 rounded-xs whitespace-nowrap transition md:w-[113px] md:px-3"
    >
