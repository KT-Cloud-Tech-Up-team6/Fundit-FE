...
- 프로젝트([#213](https://github.com/KT-Cloud-Tech-Up-team6/Fundit-FE/issues/213))·주문([#215](https://github.com/KT-Cloud-Tech-Up-team6/Fundit-FE/issues/215)) 생성은 `Idempotency-Key`로 같은 시도의 서버 결과를 되찾습니다. 리워드 생성 멱등성과 불확실한 결과 복구는 [#214](https://github.com/KT-Cloud-Tech-Up-team6/Fundit-FE/issues/214)에서 추적하며, 현재 리워드의 탭 단위 FE 방어는 다중 탭·기기 중복 방지나 서버 결과 복구를 보장하지 않습니다.
