...
2026년 9월 20일(KST, UTC+09:00) 기준입니다. 주요 화면과 목업 기반 인터랙션, 인증·회원가입 API 기반, Docker 이미지 검증 및 ECR 업로드 CI를 구현했습니다. 기능별 API 연결은 후속 PR에서 진행 중이며, 실제 BE·외부 서비스·클라우드 환경의 통합 QA는 완료되지 않았습니다.
...
| 인증 및 API 연결 | [#97](https://github.com/KT-Cloud-Tech-Up-team6/Fundit-FE/pull/97)의 인증·회원가입 기반 구현. 기능별 연결은 #200~#207에서 진행 중         |
